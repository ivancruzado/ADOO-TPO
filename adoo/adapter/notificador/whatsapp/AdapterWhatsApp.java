...
public class AdapterWhatsApp implements IAdapterWhatsApp{
    ...
    public void enviarNotificacion(NotificadorDTO notificacion) {
        System.out.println(ConsoleColors.GREEN + 
                "Se ha enviado un mensaje por Whatsapp al numero " + ConsoleColors.GREEN_BOLD + notificacion.getDestinatario().getTelefono() + ConsoleColors.GREEN
                        + " del Cliente Adoptante " + ConsoleColors.GREEN_BOLD + notificacion.getDestinatario().getNombre()
